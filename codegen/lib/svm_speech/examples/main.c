...
#include "svm_speech.h"
#include "svm_speech_terminate.h"
#include <string.h>
 ...
 * Return Type  : void
 */
void main_svm_speech(void)
{
  float in1_tmp;
  /* Initialize function 'svm_speech' input arguments. */
  in1_tmp = argInit_real32_T();
  /* Call the entry-point 'svm_speech'. */
  in1_tmp = svm_speech(
